...
// var metSites = [1, 2, 3, 4, 5, 11];
// metSites.map(function (site, index) {
// 	new CronJob((parseInt(index) + 10) + ' 21 14 * * *', function () {
// 		var options = {
// 			hostname: 'primrose-metro.elasticbeanstalk.com',
// 			// hostname: 'localhost',
// 			// port: 3000,
// 			path: '/api/mySQL/metExport/' + site,
// 			method: 'GET',
// 			headers: {
// 				'Content-Type': 'application/x-www-form-urlencoded'
// 			}
// 		};
// 		var req = http.request(options, function (res) {
// 			console.log('/api/mySQL/metExport/' + site);
// 			console.log('STATUS: ' + res.statusCode);
// 			console.log('HEADERS: ' + JSON.stringify(res.headers));
// 			res.setEncoding('utf8');
// 			res.on('data', function (chunk) {
